...
public class CharacterDataWrapper   {
  ...
  @JsonProperty("data")
  private CharacterDataContainer data = null;

  @JsonProperty("etag")
  private String etag = null;

  public CharacterDataWrapper code(BigDecimal code) {
    this.code = code;
    return this;
  }
  ...
  public CharacterDataWrapper status(String status) {
    this.status = status;
    return this;
  }
  ...
  public CharacterDataWrapper copyright(String copyright) {
  ...
  public CharacterDataWrapper attributionText(String attributionText) {
  ...
  public CharacterDataWrapper attributionHTML(String attributionHTML) {
  ...
  public CharacterDataWrapper data(CharacterDataContainer data) {
    this.data = data;
    return this;
  }
  ...
  public CharacterDataWrapper etag(String etag) {
    this.etag = etag;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CharacterDataWrapper characterDataWrapper = (CharacterDataWrapper) o;
  ...
  public String toString() {
    ...
    sb.append("class CharacterDataWrapper {\n");
