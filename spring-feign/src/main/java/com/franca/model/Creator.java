...
public class Creator   {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, creator.id) &&
        ...
        Objects.equals(this.comics, creator.comics) &&
        Objects.equals(this.events, creator.events);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, firstName, middleName, lastName, suffix, fullName, modified, resourceURI, urls, thumbnail, series, stories, comics, events);
  }
